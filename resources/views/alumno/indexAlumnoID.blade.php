<x-html-layout>
    ...
    <x-slot name="header">
        ...
        <p class="font-bold">Recuerde su contraseña: 
            <span class=" text-red-600">{{$alumno->password}})</span>
        </p>

        <div class="py-2 flex gap-5">

            <a href="{{route('alumno.edit', $alumno)}}">
                <button class="text-white bg-yellow-600 hover:bg-yellow-800 font-medium rounded-lg text-sm p-2">
                    Editar Alumno✍
                </button>
            </a>
