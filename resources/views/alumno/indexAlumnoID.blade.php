<x-html-layout>
    ...
    <x-slot name="header">
        ...
        <a href="/alumno"><button class="text-white bg-sky-900 hover:bg-teal-600 font-medium rounded-lg text-sm p-2 my-1">Volver atras</button> </a>
        <h1 class=" text-4xl font-bold text-sky-900">Hola usuario {{$alumno->nombre}} {{$alumno->apellido}}!</h1>
        ...
        <div class="py-2 flex gap-5">
            <a href="/alumno/{{$alumno->id}}/edit"><button class="text-white bg-yellow-600 hover:bg-yellow-800 font-medium rounded-lg text-sm p-2">Editar Alumno✍</button></a>
