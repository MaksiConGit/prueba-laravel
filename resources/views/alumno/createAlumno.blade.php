<x-html-layout>
    ...
    <a href="{{route('alumno.index')}}"> <button class="text-white bg-sky-900 hover:bg-teal-600 font-medium rounded-lg text-sm p-2">Volver
            atras</button> </a>
    <div class="flex flex-col items-center text-xl font-medium ">
        <div class="bg-sky-900 flex flex-col items-center w-2/4 rounded-xl p-3">
            ...
            <h2 class="py-3 text-white">INGRESE LOS DATOS DEL ALUMNO✍</h2>

            <form class="max-w-sm mx-auto " method="POST" action="/creacionAlumno">
                @csrf
                <div class="mb-5">
                    <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre del Alumno</label>
                    <input type="text" name="nombre" id="nombre"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Nombre" required />
                </div>
                <div class="mb-5">
                    <label for="apellido" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Apellido del Alumno</label>
